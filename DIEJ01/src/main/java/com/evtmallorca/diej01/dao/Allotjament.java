...
public class Allotjament {
    ...
    public Allotjament(int id, String nom, String descripcio, String adresa, String municipi, int num_persones, float reu_per_nit) {
        this.id = id;
        this.nom = nom;
